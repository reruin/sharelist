...
module.exports = ({ getSource , getConfig, request }) => {
  ...
  const pdf = async (data , req) => {
    if( req.query.conv ){
      ...
      //<iframe src="//mozilla.github.io/pdf.js/es5/web/viewer.html?file=${encodeURIComponent(}"></iframe>
      let url = createUrl(req , false , { preview:1, conv : 1})
/*
          <link rel="stylesheet" href="//mozilla.github.io/pdf.js/es5/web/">
          <link rel="resource" type="application/l10n" href="//mozilla.github.io/pdf.js/es5/web/locale/locale.properties">
          <script src="//mozilla.github.io/pdf.js/es5/build/pdf.js"></script>
          <script src="//mozilla.github.io/pdf.js/es5/web/viewer.js"></script> 
*/
      return {
        ...data,
        convertible:true,
        body: `
          <link rel="stylesheet" href="//mozilla.github.io/pdf.js/es5/web/viewer.css">
          <link rel="resource" type="application/l10n" href="//mozilla.github.io/pdf.js/es5/web/locale/locale.properties">
           <script>
            var pdfjsLib = window['pdfjs-dist/build/pdf'] || {};

            // The workerSrc property shall be specified.
            pdfjsLib.GlobalWorkerOptions.workerSrc = '//mozilla.github.io/pdf.js/es5/build/pdf.worker.js';
            window['pdfjs-dist/build/pdf'].GlobalWorkerOptions.workerSrc = '//mozilla.github.io/pdf.js/es5/build/pdf.worker.js';
